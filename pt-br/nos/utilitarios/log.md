...
[Visão Geral](../../assets/images/nos-log-visao-geral.mp4)
...
```
Mensagem: Status da API: {{ steps["http-request"].outputs.status }}, Body: {{ JSON.stringify(steps["http-request"].outputs.body) }}
```
