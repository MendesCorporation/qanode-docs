...
File artifacts with base64 are saved by QANode and exposed as fileRef outputs.
Use key/outputKey when the file should be available as a named output.
